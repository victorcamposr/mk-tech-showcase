...
CREATE POLICY "Admins can insert fiscal data" ON public.fiscal_data
...
CREATE POLICY "Users can view own fiscal data" ON public.fiscal_data
  FOR SELECT USING (auth.uid() = user_id);

CREATE POLICY "Users can insert own fiscal data" ON public.fiscal_data
  FOR INSERT WITH CHECK (auth.uid() = user_id);

CREATE POLICY "Users can update own fiscal data" ON public.fiscal_data
