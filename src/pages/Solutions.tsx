                           ...
                           {key === 'maquininhas-cartao' && (
                             <>
                                <div className="absolute bottom-3 left-3 p-0.5 rounded group/tooltip">
                                  <img src="/lovable-uploads/a8ecfad8-8626-44ee-a7eb-afcfd88ca462.png" alt="Stone" className="w-5 h-5 object-contain" />
                                ...
                                <div className="absolute bottom-3 left-12 p-0.5 rounded group/tooltip">
                                  <img src="/lovable-uploads/f8914b9c-f621-4ddb-8f33-cb631782bb48.png" alt="Cielo" className="w-5 h-5 object-contain" />
                                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 px-1.5 py-0.5 bg-gray-900 text-white text-xs rounded opacity-0 group-hover/tooltip:opacity-100 transition-opacity whitespace-nowrap z-10">
                                    Integrado com Cielo
                                  </div>
                                </div>
                                <div className="absolute bottom-3 left-21 p-0.5 rounded group/tooltip">
                                  <img src="/lovable-uploads/2a8e6032-1804-4f62-aa10-ae0ad095cab8.png" alt="PagBank" className="w-5 h-5 object-contain" />
                                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 px-1.5 py-0.5 bg-gray-900 text-white text-xs rounded opacity-0 group-hover/tooltip:opacity-100 transition-opacity whitespace-nowrap z-10">
                                    Integrado com PagBank
                                  </div>
                                </div>
