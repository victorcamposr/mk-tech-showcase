...
const ContactIcon = ({ type, className = "w-6 h-6" }: ContactIconProps) => {
  ...
  return (
    <div className="flex justify-center items-center p-2 bg-gradient-to-br from-brand-gold/10 to-brand-gold/15 rounded-lg group-hover:from-brand-gold/15 group-hover:to-brand-gold/25 transition-all duration-300">
      {icons[type]}
    </div>
  );
};
