...
const ContactIcon = ({ type, className = "w-8 h-8" }: ContactIconProps) => {
  const icons = {
    whatsapp: (
      <svg viewBox="0 0 24 24" className={`${className} text-[#25D366]`} fill="currentColor">
    ...
    email: (
      <svg viewBox="0 0 24 24" className={`${className} text-brand-gold`} fill="none" stroke="currentColor" strokeWidth="2">
    ...
    instagram: (
      <svg viewBox="0 0 24 24" className={`${className} text-[#E4405F]`} fill="none" stroke="currentColor" strokeWidth="2">
