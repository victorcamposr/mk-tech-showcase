...
const ContactIcon = ({ type, className }: ContactIconProps) => {
  ...
  const iconClassName = className || defaultSize;
  
  const icons = {
    whatsapp: (
      <svg viewBox="0 0 24 24" className={iconClassName} fill="#25D366">
    ...
    email: (
      <svg viewBox="0 0 24 24" className={iconClassName} fill="none" stroke="#D4AF37" strokeWidth="2">
    ...
    instagram: (
      <svg viewBox="0 0 24 24" className={iconClassName} fill="none" stroke="#E4405F" strokeWidth="2">
