...
const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-black via-brand-black-light to-brand-black">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-brand-black to-brand-black-light border-r border-brand-gold/30 transform transition-transform duration-300 ease-in-out ${
